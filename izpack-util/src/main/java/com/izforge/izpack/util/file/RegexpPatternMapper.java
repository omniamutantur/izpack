...
public class RegexpPatternMapper implements FileNameMapper {
     ...
     */
    public RegexpPatternMapper() throws Exception {
    ...
    public void setCaseSensitive(boolean caseSensitive) {
        regexpOptions = RegexUtil.asOptions(caseSensitive);
    }
     ...
     * @throws InstallerException on error.
     */
    public void setFrom(String from) throws InstallerException 
    {
        if (from != null) {
            try {
                reg.setPattern(from);
                ...
                throw new InstallerException("Cannot load regular expression matcher", e);
            }
        } else {
            throw new InstallerException("this mapper requires a 'from' attribute");
        }
    }
     ...
     * @throws InstallerException on error.
     */
    public void setTo(String to) throws InstallerException 
    {
        if (to != null) {
            this.to = to.toCharArray();
        } else {
            throw new InstallerException("this mapper requires a 'to' attribute");
        }
    }
